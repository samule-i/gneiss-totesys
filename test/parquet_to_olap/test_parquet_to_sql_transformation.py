...
def test_generate_sql_list_returns_list_with_correct_number_of_queries():
    ...
    expected_result = [
        ("INSERT INTO test_table %s VALUES "
         "%s "
         "on conflict (test_id) "
         "do update set %s = %s;"),
        ("INSERT INTO test_table %s VALUES "
        ...
        '(col1, col2)', '(excluded.col1, excluded.col2)'
